...
export default function Home() {
  ...
  return (
    <main className="h-[100dvh] relative overflow-hidden flex flex-col items-center justify-center p-4 bg-[#FAF9F6]">
      ...
      <motion.div
        ...
        className="w-full max-w-lg md:max-w-xl z-10 flex flex-col items-center"
      >
        <header className="text-center mb-4 md:mb-8 space-y-1">
          <p className="text-rose-400 font-medium tracking-[0.3em] uppercase text-[8px] md:text-xs">A special gift for her</p>
          <h2 className="text-lg md:text-2xl serif italic text-rose-900/60">24 Years of You</h2>
        </header>

        <Book pages={pages} />

        <footer className="mt-8 md:mt-12 text-center">
          <p className="text-rose-900/30 text-[10px] md:text-sm serif italic">
